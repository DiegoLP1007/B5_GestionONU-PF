...
public class UsuarioDao {
    ...
    public Usuario buscarPorEmail(String correo) {
        ...
        try {
            TypedQuery<Usuario> query = en.createQuery("SELECT u FROM Usuario u WHERE u.correo = :correo", Usuario.class);
    ...
    public boolean erorEmail(String correo) {
        EntityManager en = enti.createEntityManager();
        try {
            Long count = en.createQuery("select count(u) from Usuario u where u.correo = :correo", Long.class)
