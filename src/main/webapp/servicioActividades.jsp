...
<html lang="es">
    ...
    <body>
        ...
        <div class="modal" id="actividadModal">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 id="actividadModalLabel">Agregar Nueva Actividad</h2>
                </div>
                <form action="${pageContext.request.contextPath}/ServletActividad" method="post">
                    <input type="hidden" name="accion" id="formAccion" value="agregar">
                    <input type="hidden" name="idActividad" id="formIdActividad" value="">
                    ...
                    <div class="form-group">
                        <label for="modalLugar">Lugar</label>
                        <input type="text" id="modalLugar" name="lugar" class="form-control" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="modalCapacidad">Capacidad</label>
                        <input type="number" id="modalCapacidad" name="capacidad" class="form-control" required>
                    </div>
                    <div class="form-group">
        ...
        <script>
            function prepararModalAgregar() {
                document.getElementById('actividadModalLabel').innerText = 'Agregar Nueva Actividad';
                document.querySelector('#actividadModal form').reset();
                document.getElementById('formAccion').value = 'agregar';
                document.getElementById('formIdActividad').value = '';
                document.getElementById('actividadModal').classList.add('show');
            }

            function prepararModalEditar(id, idProyecto, nombre, descripcion, lugar, fecha, capacidad) {
                document.getElementById('actividadModalLabel').innerText = 'Editar Actividad #' + id;
                document.getElementById('formAccion').value = 'actualizar';
                document.getElementById('formIdActividad').value = id;
                document.getElementById('modalNombre').value = nombre;
                document.getElementById('modalDescripcion').value = descripcion;
                document.getElementById('modalLugar').value = lugar;
                document.getElementById('modalFecha').value = fecha.substring(0, 10); // yyyy-MM-dd
            ...
            function cerrarModal() {
                document.getElementById('actividadModal').classList.remove('show');
            }
